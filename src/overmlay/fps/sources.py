...
from overmlay.sensors.base import to_float
...
class MangoHudSource(FrameSource):
    ...
    `MANGOHUD_CONFIG=output_folder=~/.local/share/overmlay,autostart_log=1 mangohud %command%`
    """
...
def build_frame_source(
    ...
    *,
    ...
    if mode in ("auto", "mangohud"):
        directory = mangohud_log_dir or Path.home() / ".local/share/overmlay/mangohud"
